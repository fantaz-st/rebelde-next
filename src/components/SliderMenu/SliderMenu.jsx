...
const SliderMenu = () => {
  ...
  const { activeMenu, toggleActiveMenu, footerRef, indexRef, prevSlide, nextSlide } = ctx;

  return (
    <>
      <div className={classes.container}>
        <svg className={activeMenu ? `${classes.active} ${classes.ham} ${classes.ham6}` : `${classes.ham} ${classes.ham6}`} viewBox='0 0 100 100' width='80' onClick={toggleActiveMenu}>
